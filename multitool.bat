...
echo http://forum.xda-developers.com/showthread.php?t=1310151
echo Make sure u include ur APK-Multi-Tool2.log, and if its not a editing problem i.e 
...
ECHO *    the sourcecode of the select apk to make actual code changes                     *
ECHO ***************************************************************************************
ECHO * 3. VERBOSE THEME IMAGE TRANSFER MODE                                                *
ECHO *    This feature allows you to port entire themes from one rom to another            *
ECHO *    without the need to resign the apk files making fast easy rom theme ports        *
ECHO ***************************************************************************************
SET /P menunr=Please make your decision:
...
ECHO * 0.   Decompile apk                                                                  *
ECHO * 1.   Decompile apk (with dependencies) (For proprietary ROM apks)                   *
ECHO * 2.   Compile System APK files                                                       *
ECHO * 3.   Compile Non-System APK files                                                   *
ECHO * 4.   Sign apk                                                                       *
ECHO * 5.   Install apk                                                                    *
ECHO * 6.   Compile apk / Sign apk / Install apk (Non System Apps Only)                    *
ECHO * 7.   Back to Editor Menu                                                            *
ECHO ***************************************************************************************
SET /P menunr=Please make your decision:
IF %menunr%==0 (goto nede)
IF %menunr%==1 (goto neded)
IF %menunr%==2 (goto neco)
IF %menunr%==3 (goto neco2)
IF %menunr%==4 (goto nesi)
IF %menunr%==5 (goto neins)
IF %menunr%==6 (goto neall)
IF %menunr%==7 (goto MENU01)
:WHAT
ECHO ***************************************************************************************
ECHO *       You went crazy and entered something that wasnt part of the menu options      *
ECHO ***************************************************************************************
...
:MENU01D
ECHO ***************************************************************************************
ECHO *                          VERBOSE THEME IMAGE TRANSFER MODE                          *
ECHO ***************************************************************************************
...
PAUSE
cd themer
Start "VERBOSE THEME IMAGE TRANSFER MODE" tporter
goto MENU01
:MENU02
cd "%~dp0"
set menunr=MULTIMENU02
cls
ECHO ***************************************************************************************
